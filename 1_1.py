...
print((4 + 2)/2)
# // gives you the quotient without the deciaml part
print(16 - 2 * 5 // 3 + 1)
...
# you have to use "str(whatever variable you have assigned to the no)" in order to use the value which you have assigned to the variable
print("The value is " + str(val + 1))
...
# this will not round of to the closest integer, instead it will remove the numbers which are after the decimal point and gives you the output
print(3.99, int(3.99), type(int(3.99)))
